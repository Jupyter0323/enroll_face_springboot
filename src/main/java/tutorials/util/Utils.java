...
public final class Utils {
	...
	public static final String VERSION = "12.4.0.0";
	public static final String COPYRIGHT = "Copyright © 2011-2021 Neurotechnology";

	private static final boolean DEFAULT_TRIAL_MODE = false;

	public static boolean getTrialModeFlag() throws IOException {
		Path p = Paths.get("D:/Licenses" + FILE_SEPARATOR, "TrialFlag.txt");
		if (p.toFile().exists()) {
